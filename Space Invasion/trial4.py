...
class final_enemy(object):
    ...
    def draw(self,win):
        ...
        if self.visible:
            ...
            pygame.draw.rect(win,(255,0,0),self.hitbox,2)
            pygame.draw.rect(win,(255,180,0),(self.hitbox[0],self.hitbox[1]-20,50,10))
            pygame.draw.rect(win,(0,128,0),(self.hitbox[0],self.hitbox[1]-20,50-(5*(10-self.health)),10))
...
while run: 
    ...
    if randc==randd and entryvariable==1:
        r_laser.append(ramanan_laser(ramanan.x+50,ramanan.y+100,100,100,2))
         #   pass
    ...
    redloop+=1
    randa=random.randint(1,50)
    randb=random.randint(1,50)
